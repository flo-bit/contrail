...
const _appBskyActorProfileSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "statusphere.app.status.listRecords#appBskyActorProfile",
    ),
  ),
  /**
  ...
  "statusphere.app.status.listRecords",
  {
    params: /*#__PURE__*/ v.object({
      ...
      sort: /*#__PURE__*/ v.optional(
        /*#__PURE__*/ v.string<"createdAt" | "status" | (string & {})>(),
      ),
      /**
       * Filter by status
       */
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("statusphere.app.status.listRecords#profileEntry"),
  ),
...
const _recordSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("statusphere.app.status.listRecords#record"),
  ),

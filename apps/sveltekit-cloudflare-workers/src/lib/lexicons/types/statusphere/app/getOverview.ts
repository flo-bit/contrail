...
const _collectionStatsSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("statusphere.app.getOverview#collectionStats")),
	"collection": /*#__PURE__*/ v.string(),
	"records": /*#__PURE__*/ v.integer(),
	"unique_users": /*#__PURE__*/ v.integer(),
});
const _mainSchema = /*#__PURE__*/ v.query(
	"statusphere.app.getOverview",
	{
		"params": null,
		"output": {
			"type": "lex",
...
export const collectionStatsSchema = _collectionStatsSchema as collectionStatsSchema;
export const mainSchema = _mainSchema as mainSchema;

export interface CollectionStats extends v.InferInput<typeof collectionStatsSchema> {}
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		"statusphere.app.getOverview": mainSchema;
	}
}

...
import type { ContrailConfig, RelationConfig, ResolvedContrailConfig } from "../types";
import {
  shortNameForNsid,
...
export class HostedAdapter extends HostedAuthorityAdapter implements StorageAdapter {

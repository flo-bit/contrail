...
/** Create a dependency-free Atcute config for ordinary consumer projects.
 * Existing JavaScript or TypeScript configs remain entirely consumer-owned. */
export async function ensureConsumerLexiconConfig(options: {
  ...
  const source = `// Generated by \`contrail connect\`. Customize as needed.\nexport default {\n  generate: {\n    files: [${JSON.stringify(`${patternRoot}/**/*.json`)}],\n    outdir: "src/lexicons/",\n  },\n};\n`;
  try {
